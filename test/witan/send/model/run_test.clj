...
(comment
  ...
  (let [_ (d/set-seed! 50)
        ...
        transitions {}]
    (sut/apply-joiners-for-academic-year [model transitions] academic-year population {:joiner-beta-params joiner-beta-params :joiner-state-alphas joiner-state-alphas} calendar-year))
  [{[7 :U-B] 5, [7 :Y-B] 2, [7 :T-B] 5, [7 :V-J] 1, [7 :Y-F] 3, [7 :X-B] 1, [7 :U-R] 1} {[2019 7 :NONSEND :U-B] 5, [2019 7 :NONSEND :Y-B] 2, [2019 7 :NONSEND :T-B] 5, [2019 7 :NONSEND :V-J] 1, [2019 7 :NONSEND :Y-F] 3, [2019 7 :NONSEND :X-B] 1, [2019 7 :NONSEND :U-R] 1}]


  [{[7 :U-B] 2, [7 :X-A] 4} {[2018 7 :NONSEND :U-B] 2, [2018 7 :NONSEND :X-A] 4}]
  [{[7 :U-B] 2, [7 :X-A] 4} {[2018 7 :NONSEND :U-B] 2, [2018 7 :NONSEND :X-A] 4}]
  [{[7 :U-B] 2, [7 :X-A] 4} {[2018 7 :NONSEND :U-B] 2, [2018 7 :NONSEND :X-A] 4}]
