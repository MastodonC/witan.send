...
(deftest expected-results
  (let [expected-md5s {"historic-data.csv" "208d196285b0648f6f66697b32dcbc4e"
                       "Output_AY.csv" "87a50609a022e34478d17deed082ad7f"
                       ...
                       "valid-settings.csv" "7035222149956f42fb5128126296817b"}
