...
We go through the calculation of an entity's next state to show how
the algorithm works and to embed the meaning of the myriad of
parameters.
...
For our two years of historic data let's assume it's 
