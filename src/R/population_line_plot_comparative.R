# SEND total count line plot - comparative version
# equivalent to population-line-plot
...
## transparency of lines and ribbons
alpha_line = 0.5
alpha_ribbon = 0.2
...
count_data_baseline = read.csv("/Users/sunnyt/Documents/Mastodon C/SEND working folder/total population/TH-VersionA-baseline-29-03-18-Count.csv") %>%
  mutate(group = "baseline")

### import the scenario dataset
count_data_scenario = read.csv("/Users/sunnyt/Documents/Mastodon C/SEND working folder/total population/TH-VersionA-scenario1-27-04-18-Count.csv") %>%
