...
cost_data_baseline = read.csv("/Users/sunnyt/Documents/Mastodon C/witan.send/data/TH-VersionA-baseline-29-03-18/TH-VersionA-baseline-29-03-18-Count.csv")
...
cost_data_scenario = read.csv("/Users/sunnyt/Documents/Mastodon C/witan.send/data/TH-VersionA-scenario1-27-04-18/TH-VersionA-scenario1-27-04-18-Cost.csv")
...
cost_data = cost_data_baseline#bind_rows(cost_data_baseline, cost_data_scenario)
